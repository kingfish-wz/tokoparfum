...
if (isset($_POST['tambah'])) {
  ...
  if (in_array($ext, $ekstensi)) {
    $query = $koneksi->query("INSERT INTO tb_barang VALUES ('$kode_barang', '$nama', '$harga', '$stok', '$gambar')");
    if ($query) {
      echo "<script>
...
<div class="container-fluid mt--7">
          ...
          <form method="POST" action="" enctype="multipart/form-data">
            <div class="container-fluid">
              ...
              <div class="form-group">
                ...
                <input type="text" name="harga" class="form-control" id="exampleInputPassword1" value="<?= $getData['harga'] ?>" required="true">
              </div>
              <div class="form-group">
    ...
    <?php else : ?>
      <form method="POST" action="" enctype="multipart/form-data">
        <div class="container-fluid">
          ...
          <div class="form-group">
            <label for="exampleInputPassword1">Stok</label>
            <input type="text" name="stok" class="form-control" id="exampleInputPassword1" required="true">
          </div>
          <div class="form-group">
            <input type="file" name="foto" class="form-control-file" id="exampleFormControlFile1" required="true">
          </div>
  ...
  <?php if (isset($_POST['update'])) {
    ...
    $stok = $_POST['stok'];
    if (empty($file)) {
      $query = $koneksi->query("UPDATE tb_barang SET nama_barang = '$nama',  harga ='$harga', stok = $stok WHERE kode_barang = '$_GET[edit_id]' ");
      if($query) {
        echo "<script>
